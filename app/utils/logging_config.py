...
def setup_logging():
    ...
    # Create logs directory if it doesn't exist (optional, but good practice)
    ...
    logging.getLogger("openai").setLevel(logging.INFO) # Keep OpenAI client logs at INFO level